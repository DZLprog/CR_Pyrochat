...
class TimeFernetGui(fernetGui):
    ...
    def encrypt(self, plaintext):
        ...
        #Args: plaintext (str): The message to encrypt.
    ...
    def decrypt(self, data):
        ...
        #Args:data (bytes): The encrypted message.

        #Returns: str: The decrypted plaintext message.

        #Raises:InvalidToken: If the message cannot be decrypted due to an invalid Fernet key or an expired TTL.
